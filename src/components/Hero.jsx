...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative overflow-hidden w-full px-4 py-16 min-h-screen bg-white dark:bg-[#0f172a]"
    >
      <div className="absolute inset-0 z-0">
       <div className="absolute top-20 left-20 w-56 h-56 sm:w-72 sm:h-72 bg-blue-500/20 dark:bg-blue-400/10 rounded-full blur-xl animate-pulse"></div>
